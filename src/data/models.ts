...
export const models: Model[] = [
  {
    ...
    "task": "点云处理",
    "paper_title": "3D Geometry Graph Network for Point Cloud Processing",
  ...
  },
  {
    "id": "slrnet",
    "name": "SLRNet",
    "full_name": "Sign Language Recognition Network with Multi-modal Fusion",
    "description": "多模态融合手语识别网络。该方法通过多模态信息融合提升手语识别精度。",
    "task": "手语识别",
